...
import { getQuestionnaireAssignmentById } from 'apiSdk/questionnaire-assignments';
...
function QuestionnaireAssignmentViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Questionnaire Assignment Detail View
          </Text>
          {hasAccess('questionnaire_assignment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/questionnaire-assignments/edit/${data?.id}`} passHref legacyBehavior>
              <Button
...
})(QuestionnaireAssignmentViewPage);
